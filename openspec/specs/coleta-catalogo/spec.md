...
Obter o catálogo do Portal Brasileiro de Dados Abertos e guardá-lo em disco no
formato em que a API o entrega, para que todas as etapas seguintes do pipeline
trabalhem sobre um insumo estável, sem depender da rede nem da disponibilidade
do servidor da CGU.
