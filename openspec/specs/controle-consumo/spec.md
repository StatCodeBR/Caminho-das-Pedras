...
Um endpoint público que chama modelo de linguagem é uma conta bancária aberta na
internet. Sem contenção, um script consome o orçamento de meses numa noite — e o
serviço cai justamente quando alguém resolve avaliá-lo.

A resposta usual seria exigir cadastro, o que aqui seria contraproducente: o
produto existe para derrubar barreiras de acesso a dados públicos. A saída é
conter sem identificar.

Dois limites de naturezas opostas. O teto diário protege o orçamento e nunca
produz erro: ao estourar, o serviço responde por template — fica menos
conversacional, não indisponível. O limite por origem protege contra abuso e
recusa, porque quem faz vinte perguntas numa hora não é visitante.
